...
class Config:
    ...
    # ======================== 数据路径 ========================
    dataset_path: str = 'data/Strawberry Greenhouse Environmental Control Dataset(version2).csv'
    weather_path: str = 'data/POWER_Point_Hourly_20250517_20250618_048d33N_025d93E_LST.csv'
