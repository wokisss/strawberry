# -*- coding: utf-8 -*-
"""Generate standard forecast figures for the trained fair-budget DLinear forecaster."""
...
from benchmark_dlinear_forecaster import (
...
def _run_name(cfg: AGCConfig, regime: str, target_compartment: str) -> str:
    ...
    return f"dlinear_forecaster{horizon_suffix}_{regime}_{target_compartment.lower()}"
...
def _build_model(cfg: AGCConfig, bundle) -> ConditionalDLinearForecaster:
