# -*- coding: utf-8 -*-
"""Residual forecaster using DLinear main path and PatchTST residual path."""

import torch
import torch.nn as nn

from models.dlinear_forecaster import ConditionalDLinearForecaster
from models.patchtst_forecaster import ConditionalPatchTSTForecaster


class ConditionalPatchTSTResidualForecaster(nn.Module):
    """Use DLinear as the main path and PatchTST as a residual corrector."""
    ...
    def __init__(
        ...
        self.residual_model = ConditionalPatchTSTForecaster(
            seq_len=seq_len,
            past_dim=past_dim,
            weather_dim=weather_dim,
            control_dim=control_dim,
