# -*- coding: utf-8 -*-
"""Residual hybrid forecaster that combines DLinear and transformer-hybrid branches."""
...
class ConditionalHybridResidualForecaster(nn.Module):
    """Use DLinear as the main path and transformer-hybrid as a residual corrector."""
    ...
    def __init__(
        ...
        self.residual_model = ConditionalTransformerHybridForecaster(
            past_dim=past_dim,
            weather_dim=weather_dim,
            control_dim=control_dim,
            target_dim=target_dim,
