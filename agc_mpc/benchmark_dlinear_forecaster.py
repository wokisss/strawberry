# -*- coding: utf-8 -*-
"""Benchmark DLinear forecaster with a fairer budget."""
...
def main() -> None:
    ...
    print("=" * 72)
    print("DLinear Forecaster Benchmark")
    print("=" * 72)
    print(f"device: {device}")
    print(f"regime: {args.regime}")
    print(f"target_compartment: {args.target_compartment}")
    print("protocol:")
    print("    model_family = dlinear")
    ...
    model = ConditionalDLinearForecaster(
        seq_len=cfg.seq_len,
        horizon=cfg.horizon,
    ...
    run_name = f"dlinear_forecaster{horizon_suffix}_{args.regime}_{args.target_compartment.lower()}"
    ...
    summary = {
        ...
        "regime": args.regime,
        "protocol": {
            "intent": "Train a DLinear forecaster under the same fair-budget protocol used by hybrid residual.",
