# -*- coding: utf-8 -*-
"""Benchmark current AGC hybrid-transformer with a fairer training budget."""
...
def main() -> None:
    ...
    print("=" * 72)
    print("Current AGC Hybrid Transformer Benchmark")
    print("=" * 72)
    print(f"device: {device}")
    print(f"regime: {args.regime}")
    print(f"target_compartment: {args.target_compartment}")
    print("protocol:")
    print("    model_family = current agc hybrid-transformer")
    ...
    run_name = f"current_hybrid_transformer{horizon_suffix}_{args.regime}_{args.target_compartment.lower()}"
    ...
    summary = {
        ...
        "regime": args.regime,
        "protocol": {
            "intent": "Train the current AGC hybrid-transformer with a fairer budget for cross-dataset comparison.",
    ...
    print("\n" + "=" * 72)
    print("Current hybrid-transformer summary")
    print("=" * 72)
